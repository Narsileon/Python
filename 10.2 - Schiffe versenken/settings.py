...
def validate_grid_settings():
    ...
    size_x = mathf.clamp(size_x, size_min, size_max, "size_x")
    size_y = mathf.clamp(size_y, size_min, size_max, "size_y")
...
def validate_ship_settings():
    ...
    ship_size_max = mathf.clamp(ship_size_max, size_min, size_max, "ship_size_max")
    ship_size_min = mathf.clamp(ship_size_min, size_min, ship_size_max, "ship_size_min")

    ships_count_min = 1
    ships_count_max = math.floor(size_x * size_y / ship_size_max / 4)
    
    ships_count = mathf.clamp(ships_count, ships_count_min, ships_count_max, "ships_count")
...
def validate_game_settings():
    ...
    turns_count = mathf.clamp(turns_count, turns_count_min, turns_count_max, "turns_count")